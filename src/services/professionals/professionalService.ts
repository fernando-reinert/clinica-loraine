 ...
 */
export const createProfessional = async (params: CreateProfessionalParams): Promise<Professional> => {
  const { data, error } = await supabase
    .from('professionals')
    .insert([
      {
...
export const updateProfessional = async (
  ...
  updates: Partial<Omit<Professional, 'id' | 'user_id' | 'created_at' | 'updated_at'>>
 ...
 */
export const getOrCreateProfessional = async (userId: string, userEmail: string): Promise<Professional | null> => {
 ...
 */
export const ensureDefaultProfessionalProfile = async (user: { id: string; email?: string | null }): Promise<Professional> => {
