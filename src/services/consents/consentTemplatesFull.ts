...
export const FULL_CONSENT_TEMPLATES: Record<string, string> = {
 ...
 */
export const getFullConsentTemplate = (procedureKey: string): string | null => {
 ...
 */
export const hasFullConsentTemplate = (procedureKey: string): boolean => {
