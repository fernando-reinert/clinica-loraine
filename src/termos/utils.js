 ...
 */
export function parseLicenseSiglaNumero(license) {
    if (!license)
        return { sigla: '', numero: '' };
 ...
 */
export function formatProfessionalLicense(license) {
    if (!license)
        return '';
 ...
 */
export function removeUnnecessarySections(text) {
    let cleaned = text;
 ...
 */
export function replaceAllPlaceholders(text, ctx) {
    let result = text;
    // Formatar valores
