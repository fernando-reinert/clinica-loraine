 ...
 */
export const PROCEDURE_NAME_MAP = {
    'botox': 'Botox',
 ...
 */
export const getProcedureDisplayName = (procedureKey) => {
 ...
 */
export const procedureNameToKey = (procedureName) => {
 ...
 */
export const normalizeProcedure = (procedureKey, procedureLabel) => {
